...
Toy 8-bit CPU in Python. Not a real ISA — built to make fetch-decode-execute
...
- **ACC (Accumulator)** — general-purpose register holding the "current" value most
  ALU ops work on. Toy CPUs (and early real ones) center everything around one
  accumulator; modern CPUs have many general-purpose registers instead.
